...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=43d40b666a6b675f992233787213272e`);
      // const response = await fetch(`https://api.themoviedb.org/3/movie/278?api_key=43d40b666a6b675f992233787213272e`);
      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <p className="my-4">
            ...
            <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">Click here</a>
          </p>
